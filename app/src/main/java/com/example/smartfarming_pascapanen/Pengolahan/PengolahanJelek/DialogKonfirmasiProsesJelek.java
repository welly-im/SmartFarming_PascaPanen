...
import com.example.smartfarming_pascapanen.Pengolahan.PengolahanBagus.DataModelPengolahanBagusKonfirmasiDataCuacaAdapter;
...
public class DialogKonfirmasiProsesJelek extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestQueue queue = Volley.newRequestQueue(DialogKonfirmasiProsesJelek.this.getContext());
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Toast.makeText(DialogKonfirmasiProsesJelek.this.getContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DialogKonfirmasiProsesJelek.this.getContext(), error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    linearLayoutManager = new LinearLayoutManager(DialogKonfirmasiProsesJelek.this.getContext());
                    recyclerView.setLayoutManager(linearLayoutManager);
                    adapter4 = new ListPengolahanBagusKonfirmasiDataCuacaAdapter(DialogKonfirmasiProsesJelek.this.getContext(), listData4);
